...
def train_test_split_dataset(ds_spec, y=None, test_size=0.25, **kwargs):
    ...
    ds_spec : ``dict``
        ...
        references.
    y : :external:term:`array-like`, optional
        The target values.
    ...
    if isinstance(ds.main_table, FileTable):
        raise ValueError("Only Pandas and Numpy datasets may be used in this method.")
...
def _train_test_split_in_memory_dataset(ds, y, test_size, split_params=None):
