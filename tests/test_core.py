...
class KhiopsCoreIOTests(unittest.TestCase):
    ...
    def test_std_streams_files(self):
        ...
        def _test(stream_name, mock_raw_run):
            ...
            stream_kwargs = {f"{stream_name}_file_path": stream_file_path}
            ...
            with mock.patch.object(KhiopsLocalRunner, "raw_run", new=mock_raw_run):
                kh.check_database(*stream_args, **stream_kwargs)
            ...
            # Clean up and restore the runner
...
def create_mock_raw_run(stdout, stderr, return_code):
    ...
    # Disable unused-variable: The mock parameters are just there to match the signature
    # pylint: disable=unused-argument
    def _mock_raw_run(
        self, tool_name, command_line_args=None, use_mpi=True, trace=False
    ):
        return (
